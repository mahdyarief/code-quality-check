...
A comprehensive codebase verification tool that executes three critical pillars of quality control. It enforces strict standards to ensure semantic correctness, structural integrity, and syntactic consistency across your projects.
...
2. Run the `no_ai_slop` semantic checker on modified files.
